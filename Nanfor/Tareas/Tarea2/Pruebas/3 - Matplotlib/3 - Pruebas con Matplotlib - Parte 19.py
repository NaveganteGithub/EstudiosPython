...
''' 
Se puede especificar que dato ira a cierto diagrama solo
con especificar lo siguiente en el "axes"

NOTA : Asegurate siempre que la cantidad de valores de cada clave de los
diccionarios que se pasen por el segundo parametro, tengan la misma cantidad
de valores que tenga el diccionario pasado por el primer parametro
'''
axes[0, 0].plot(platos_dia, ventas["Avenida de Rafael Alberti"], color='tab:red', marker='.', linestyle='dashed')
axes[0, 0].plot(platos_dia, stock["Avenida de Rafael Alberti"], color='tab:green', marker='^', linestyle='dotted')

axes[0, 1].plot(platos_dia, ventas["Avenida de palomeras"], color='tab:red', marker='.', linestyle='dashed')
axes[0, 1].plot(platos_dia, stock["Avenida de palomeras"], color='tab:green', marker='^', linestyle='dotted')

axes[0, 2].plot(platos_dia, ventas["Avenida Buenos Aires"], color='tab:red', marker='.', linestyle='dashed')
axes[0, 2].plot(platos_dia, stock["Avenida Buenos Aires"], color='tab:green', marker='^', linestyle='dotted')

axes[1, 0].plot(platos_dia, ventas["Avenida de la Albufera"], color='tab:red', marker='.', linestyle='dashed')
axes[1, 0].bar(platos_dia, stock["Avenida de la Albufera"], color='tab:green', linestyle='dotted')

axes[1, 1].plot(platos_dia, ventas["Calle Serrano"], color='tab:red', marker='.', linestyle='dashed')
axes[1, 1].bar(platos_dia, stock["Calle Serrano"], color='tab:green', linestyle='dotted')

axes[1, 2].plot(platos_dia, ventas["Calle Alcala"], color='tab:red', marker='.', linestyle='dashed')
axes[1, 2].bar(platos_dia, stock["Calle Alcala"], color='tab:green', linestyle='dotted')
