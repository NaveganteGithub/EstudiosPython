...
# legend permite agregar una leyenda
axes.legend(['Ventas Avenida de Rafael Alberti', 
             'Stock Avenida de Rafael Alberti', 
             'Ventas Avenida de palomeras', 
             'Stock Avenida de palomeras'], loc = 'upper left')
