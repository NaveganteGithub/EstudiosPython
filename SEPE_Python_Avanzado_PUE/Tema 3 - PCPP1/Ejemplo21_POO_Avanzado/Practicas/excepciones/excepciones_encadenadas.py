...
# Una excepcion explicita se genera cuando salta una excepcion
...
# Una excepcion implicita se genera cuando se intenta manejar una excepcion que no se puede manejar.
