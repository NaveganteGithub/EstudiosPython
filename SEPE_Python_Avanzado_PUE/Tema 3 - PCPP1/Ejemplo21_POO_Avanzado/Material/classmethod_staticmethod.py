...
class Student:
    ...
    # Esto es un Metodo de Clases porque recibe cls, y cls es un puntero 
    # que apunta a la clase
    #class method
    @classmethod
    ...
    # Esto es un Metodo de Instancia porque recibe self, y self es un puntero 
    # que apunta a la instancia del objeto
    def prueba(self):
        print("Buenos dias")
...
Student.student_full_name("Pepito", "56") 
